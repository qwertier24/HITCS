...
HD_PWD='E:/HITCS/principles-of-computer-organization/exp2/ram/ram.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log perform.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source perform.tcl
