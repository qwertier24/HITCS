...
HD_PWD='E:/HITCS/principles-of-computer-organization/exp1/bus_controller/bus_controller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bus_controller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bus_controller.tcl
