...
<body class="nav-md">
              ...
              <ul class="nav side-menu">
                <li><a><i class="fa fa-table"></i> 图书查询/修改<span
                  ...
                  <ul class="nav child_menu">
                    <li class="current-page"><a href="queryBook.jsp">查询图书信息</a></li>
  ...
  <script src="/library/static/js/non-common/queryBook.js"></script>
