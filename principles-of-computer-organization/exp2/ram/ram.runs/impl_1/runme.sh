...
HD_PWD='E:/HITCS/principles-of-computer-organization/exp2/ram/ram.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log perform.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source perform.tcl -notrace
