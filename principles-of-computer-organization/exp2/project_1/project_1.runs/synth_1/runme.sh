...
HD_PWD='E:/HITCS/principles-of-computer-organization/exp2/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ram2114.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ram2114.tcl
