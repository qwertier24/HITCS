...
HD_PWD='E:/HITCS/principles-of-computer-organization/exp1/bus_controller/bus_controller.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bus_controller.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bus_controller.tcl -notrace
