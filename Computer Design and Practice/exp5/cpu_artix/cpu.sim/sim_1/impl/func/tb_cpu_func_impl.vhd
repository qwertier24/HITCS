...
-- Date        : Sat Jul 22 21:02:26 2017
-- Host        : DESKTOP-IQ9RCDV running 64-bit major release  (build 9200)
-- Command     : write_vhdl -mode funcsim -nolib -force -file
--               E:/HITCS/exp5/cpu/cpu.sim/sim_1/impl/func/tb_cpu_func_impl.vhd
-- Design      : cpu
...
\plusOp_carry__2\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => '0',
      S(2 downto 0) => O_PC(15 downto 13)
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
...
entity cpu is
  ...
  attribute ECO_CHECKSUM of cpu : entity is "656dd07f";
end cpu;
