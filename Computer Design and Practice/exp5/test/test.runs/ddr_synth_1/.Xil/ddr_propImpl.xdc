set_property SRC_FILE_INFO {cfile:e:/HITCS/test/test.srcs/sources_1/ip/ddr/ddr/user_design/constraints/ddr.xdc rfile:../../../test.srcs/sources_1/ip/ddr/ddr/user_design/constraints/ddr.xdc id:1 order:EARLY} [current_design]
